...
// LAST_CHANGE: v0.1.5 - Dragon dispatch extracted to `game-dragon.scala` (`GameDragonSupport` + `dragonDispatchPart3`); `caveTailPart3` holds Cave/Thief/board tail. v0.1.4: Part2/Part3 split; v0.1.3: traits.
// END_CHANGE_SUMMARY
package vast
//
//
...
class Game(val setup : $[Faction], val options : $[Meta.O]) extends BaseGame with ContinueGame with LoggedGame with GameThiefSupport with GameSetupSupport with GameDragonSupport {
