...
// LAST_CHANGE: v0.1.6 - Goblins dispatch extracted to `game-goblins.scala` (`GameGoblinsSupport` + `goblinDispatchPart2`). v0.1.5: Dragon/`caveTailPart3`. v0.1.4: Part2/Part3 split; v0.1.3: traits.
// END_CHANGE_SUMMARY
package vast
//
//
...
class Game(val setup : $[Faction], val options : $[Meta.O]) extends BaseGame with ContinueGame with LoggedGame with GameThiefSupport with GameSetupSupport with GameGoblinsSupport with GameDragonSupport {
