---
name: grace-fixer
description: GRACE failure-packet fixer for targeted module repairs. Use proactively when tests fail or behavior regresses, keeping fixes minimal and in-scope.
---
