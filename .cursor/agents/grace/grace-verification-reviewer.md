---
name: grace-verification-reviewer
description: GRACE verification gate reviewer for module-local test quality and observability. Use proactively before closing a module step to assess verification sufficiency.
---
