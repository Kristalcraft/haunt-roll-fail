---
name: grace-contract-reviewer
description: GRACE scoped contract gate reviewer. Use proactively after a module implementation step to validate contract compliance, scope boundaries, and graph delta accuracy.
---
